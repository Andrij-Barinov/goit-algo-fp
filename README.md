...
![](https://s3.eu-north-1.amazonaws.com/lms.goit.files/9ed4edf8-bfc6-4e09-bb32-3aeef75b381cUntitled%20%2822%29.png)
...
class Node:
  def \_\_init\_\_(self, key, color\="skyblue"):
    self.left = None
    self.right = None
    self.val = key
...
![](https://s3.eu-north-1.amazonaws.com/lms.goit.files/4dc212c2-e9d6-4f8f-822a-7d268fcc7148Untitled%20%2823%29.png)
...
3\. Завантажте робочі файли на свій комп’ютер та прикріпіть їх у LMS у форматі `zip`. Назва архіву повинна бути у форматі ФП\__ПІБ_.

4\. Прикріпіть посилання на репозиторій `goit-algo-fp` та відправте на перевірку.

**Формат здачі**

- Прикріплені файли репозиторію у форматі `zip` з назвою ФП\__ПІБ._
